      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
        <div className="mb-5 sm:mb-8">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Un código de verificación ha sido enviado a su teléfono. Por favor,
            ingrese el código abajo.
          </p>
        </div>
        <div>
          <form>
            <div className="space-y-5">
              {/* <!-- Email --> */}
              <div>
                <Label>Escriba su código de seguridad de 6 digitos</Label>
        ...
        >
          <img width={140} height={48} src="/images/logo/LUZ.png" alt="Logo" />
        </Link>
      </div>
    </div>
  );
